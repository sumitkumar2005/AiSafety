...
const Dashboard = () => {
  ...
  return (
      <div>
        <nav>
          <h1 className="text-4xl font-bold m-2 text-center">AI Safety Incident Dashboard</h1>
        </nav>
        <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 py-12 container mx-auto">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">

            {/* Control header */}
            <div className="mb-8">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-white rounded-xl shadow-md p-6">
                <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 flex items-center">
                ...
                <div>
                  ...
                  <p className="text-xl font-semibold">{incidents.filter(i => i.severity === 'High').length}</p>
                </div>
              </div>
                  ...
                  <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 text-center">
                    ...
                    {severityFilter !== 'All' && (
                        <button
                            ...
                            className="mt-4 px-4 py-2 text-sm text-indigo-600 bg-indigo-50 rounded-md hover:bg-indigo-100 transition-colors"
                        >
                          Clear filters
                        </button>
                    )}
            ...
            <div className="mt-12 text-center text-sm text-gray-500">
              <p>AI Safety Incident Dashboard • Made By Sumit</p>
            </div>
          </div>
        </div>
      </div>
