      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-3">
          <label className="text-sm font-medium text-gray-700 whitespace-nowrap flex items-center">
            <svg className="h-5 w-5 mr-1.5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              className={`px-3.5 py-1.5 text-sm rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-300 transition-colors ${
                severityFilter === 'All'
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-3">
          ...
          <div className="inline-flex rounded-md shadow-sm">
            <button
              className={`px-3.5 py-1.5 text-sm rounded-l-md focus:z-10 focus:outline-none focus:ring-2 focus:ring-indigo-300 transition-colors border ${
                sortOrder === 'newest'
            ...
            <button
              className={`px-3.5 py-1.5 text-sm rounded-r-md focus:z-10 focus:outline-none focus:ring-2 focus:ring-indigo-300 transition-colors border ${
                sortOrder === 'oldest'
                  ? 'bg-indigo-600 text-white border-indigo-600'
                  : 'bg-white text-gray-700 hover:bg-gray-100 border-gray-300'
              }`}
